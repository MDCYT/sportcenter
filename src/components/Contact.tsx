...
const Contact = () => {
    return ( 
        <div className="h-[calc(80vh-4rem)] bg-[url('/images/bgcontact.png')] bg-no-repeat bg-auto bg-center">
        <div className="h-[calc(80vh-4rem)] grid grid-cols-2 gap-2 text-white">
          <div className="flex flex-wrap flex-col	items-center align-middle justify-center">
            <div className="mx-24 text-center flex flex-col items-center justify-center">
              ...
              <br />
              <a href={"/contact"}
                className={'bg-[#25D366] text-white hover:bg-gray-700 hover:text-white rounded-3xl px-3 py-2 text-sm font-medium transition-color duration-200 flex flex-row text-center items-center justify-center w-3/4 sm:w-1/2'
                }
              >
